...
function AccessibilityToolsPreferences() {
    ...
    if ($_REQUEST["action"] == "save") {
        ...
        update_option( MSAT_AccessibilityTools::MSAT_COMPUTER_VISION_CONFIDENCE, str_replace(",", ".", $_REQUEST[MSAT_AccessibilityTools::MSAT_COMPUTER_VISION_CONFIDENCE]), true );
    ...
    $msat_options = array(
        ...
        MSAT_AccessibilityTools::MSAT_COMPUTER_VISION_CONFIDENCE,
    ...
    foreach ($languages as $key => $value) {
        $selected = "";
        if (get_option( MSAT_AccessibilityTools::MSAT_LANGUAGE ) == $key) {
            $selected = "selected";
        }
